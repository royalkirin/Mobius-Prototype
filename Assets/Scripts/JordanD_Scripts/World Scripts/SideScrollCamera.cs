...
public class SideScrollCamera : MonoBehaviour
{
    ...
    Vector3 uCamDistance = new Vector3(0.0f, 0.0f, -5.0f);
    [SerializeField] Quaternion uDebug;
    #endregion
    ...
    void FollowPlayer()
    {
        ...
        PlayerPos = uPlayerTransform.position;
        uDebug = transform.rotation;
    }
}
