...
public class TutorialCardPlayer : MonoBehaviour
{
    ...
    CardChain cardChain;
    public TutorialDeck playerDeck; //deck of the player, or enemy, depends on the friendlyTag
    ...
    private void FindVariables()
    {
        ...
        {
            playerDeck = GameObject.FindWithTag("PlayerDeck").GetComponent<TutorialDeck>();
        }else if (friendlyTag == "EnemyCharacter")
        {
            playerDeck = GameObject.FindWithTag("EnemyDeck").GetComponent<TutorialDeck>();
        }
