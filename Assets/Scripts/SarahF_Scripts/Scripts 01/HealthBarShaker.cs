    ...
    void FixedUpdate()
    {
        if (startBeat && timerShake <= 0)
        {
            ...
            if (timer >= 5 && timer <= 9)
            {
                ...
                gameObject.GetComponent<Image>().color = new Color(0.004716992f, 1f, 0.04873455f, 1f);
            }
        ...
        if (startShake && timerBeat <= 0)
        {
            ...
            if (timer >= 5 && timer <= 9)
            {
                ...
                gameObject.GetComponent<Image>().color = new Color(0.2794589f, 0.3773585f, 0.2836986f, 1f);
            }
            else if (timer >= 10 && timer <= 14)
            {
